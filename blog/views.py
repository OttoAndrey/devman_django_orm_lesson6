...
def index(request):
    sorted_posts_by_likes = Post.objects.annotate(num_likes=Count('likes')).order_by('-num_likes').prefetch_related('author')
    most_popular_posts = sorted_posts_by_likes[:5]
